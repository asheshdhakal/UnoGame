...
namespace UnoGame
{
    public partial class UNO : Form
    {
        ...
        {
            string rulesText = "These are the rules of the game:\n\n1. You must match the color or the number with the card currently being play, if you do not have, pull a card from the deck.\n2. If you get a wild card you may select the colour you wish to now play." +
                "\n3. If you have one card left (UNO) you will be highlighted red, to call it out. Finish all of your cards to win!! \n\nEnjoy playing!";
            MessageBox.Show(rulesText, "Game Rules", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void pictureBoxPlayer4Card6_Click(object sender, EventArgs e)
        {
